...
const columns = [
  ...
  //   key: "notifyByEmail",
  //   slots: { customRender: 'notifyByEmail' },
  //   ellipsis: true,
  //   tooltip: true,
  // },
  // {
  //   title: "RptByEmail",
  //   dataIndex: "rptByEmail",
  //   key: "rptByEmail",
  //   slots: { customRender: 'rptByEmail' },
  //   ellipsis: true,
  //   tooltip: true,
  // },
  // {
  //   title: "DataPaired",
  //   dataIndex: "dataPaired",
  //   key: "dataPaired",
  //   slots: { customRender: 'dataPaired' },
  //   ellipsis: true,
  //   tooltip: true,
  // },
  // {
  //   title: "RnaStrandness",
  //   dataIndex: "rnaStrandness",
  //   key: "rnaStrandness",
  //   slots: { customRender: 'rnaStrandness' },
  //   ellipsis: true,
  //   tooltip: true,
  // },
  // {
  //   title: "Merge",
  //   dataIndex: "orderMerge",
  //   key: "orderMerge",
  //   ellipsis: true,
  //   tooltip: true,
  // },
