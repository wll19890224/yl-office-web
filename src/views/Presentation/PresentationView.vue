      ...
      <div class="row">
        <div class="col-lg-4">
          <FilledInfoCard
            ...
            title="Instruction"
            description="The prediction is based on gene expression levels computed from bulk 
RNA-seq of primary tumor tissue of breast cancer patient."
            :action="{
              route:
                '/pages/landing-pages/breastcancer',
        ...
        <div class="col-lg-4">
          <FilledInfoCard
            ...
            title="Our mission"
            description="We are passionate about making contributions to improve 
human health of the world through state-of-the-art 
precision medicine."
            :action="{
              route:
                '/pages/landing-pages/about-us',
        ...
        <div class="col-lg-4">
          <FilledInfoCard
            ...
            title="Contact us"
            description="We would appreciate any suggestions, comment, or 
